...
exports.updateProduct = (req, res) => {
    ...
    form.parse(req, (err, fields, files) => {
        ...
        let product = req.product
        // extend method of loadsh used to update product takes two arg. first product itself and 2nd updated field
...
exports.relatedList = (req, res) => {
    ...
    Product.find({ _id: { $ne: req.product }, category: req.product.category })  // $ne means : not included
        .limit(limit)
