...
sgMail.setApiKey('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')
...
/**
 *  For mailing purpose for buyer and admin
 */
...
exports.create = (req, res) => {
    ...
    order.save((error, data) => {
        ...
        // order.amount
        const emailData = {
            to: 'mahajanayush808@gmail.com', // admin
            from: 'my_cart@ecommerce.com',
